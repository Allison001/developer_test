...
def test_attach_picture():
    allure.attach.file(source="https://exp-picture.cdn.bcebos.com/2a1ecb460596b814e9fce0b043d246fe464e2283.jpg?x-bce-process=image%2Fresize%2Cm_lfit%2Cw_500%2Climit_1",name="图片链接",attachment_type=allure.a)
